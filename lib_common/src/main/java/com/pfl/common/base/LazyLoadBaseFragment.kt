 ...
 */
abstract class LazyLoadBaseFragment : BaseFragment() {
    ...
    private val isParentInvisible: Boolean
        get() {
            ...
            return if (parentFragment is LazyLoadBaseFragment) {
                val fragment = parentFragment as LazyLoadBaseFragment?
    ...
    private fun dispatchChildVisibleState(visible: Boolean) {
        ...
        if (!fragments.isEmpty()) {
            for (child in fragments) {
                if (child is LazyLoadBaseFragment && !child.isHidden() && child.getUserVisibleHint()) {
